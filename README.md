...
Welcome to the AdvancedTeleport wiki!
...
{% hint style="warning" %}
1.8 to 1.17.1 support will be dropped in the near future.
{% endhint %}
...
AdvancedTeleport is open-source on Github [here](https://github.com/Niestrat99/AT-Rewritten). To build the plugin, the command used is `mvn clean install -Denv.BUILD_NUMBER=PRIVATE`, where the build number is set to private and nothing else.
